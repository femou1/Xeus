...
public class PBMBlacklistUpdateJob extends Job {

    private final String cacheToken = "blacklist.pbm.blacklists";
    private static final Logger log = LoggerFactory.getLogger(PBMBlacklistUpdateJob.class);

    public PBMBlacklistUpdateJob(AvaIre avaire) {
