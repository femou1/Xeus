...
public abstract class VerificationCommandContract extends Command {
    ...
    /**
     * Creates the given command instance by calling {@link #VerificationCommandContract(AvaIre, boolean)} with allowDM set to true.
     *
     * @param avaire The AvaIre class instance.
     */
    public VerificationCommandContract(AvaIre avaire) {
        this(avaire, true);
    }
     ...
     */
    public VerificationCommandContract(AvaIre avaire, boolean allowDM) {
