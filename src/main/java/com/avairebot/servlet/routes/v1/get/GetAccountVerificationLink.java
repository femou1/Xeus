...
public class GetAccountVerificationLink extends SparkRoute {
    ...
    public Object handle(Request request, Response response) throws Exception {
        ...
        HashMap<Long, String> inVerificationSystem = AvaIre.getInstance().getRobloxAPIManager().getVerification().getInVerification();
        if (inVerificationSystem.containsKey(Long.valueOf(robloxId))) {
            ...
            User u = AvaIre.getInstance().getShardManager().getUserById(userId);
