...
import com.pinewoodbuilders.commands.system.plugin.InstallPlugin;
import com.pinewoodbuilders.commands.system.plugin.ListPlugins;
import com.pinewoodbuilders.commands.system.plugin.ShowPlugin;
import com.pinewoodbuilders.commands.system.plugin.UninstallPlugin;
...
public class PluginCommand extends SystemCommand {
    ...
    public PluginCommand(Xeus avaire) {
        super(avaire);
    ...
    public String getDescription() {
        return "Can be used to list installed plugins, as well as available plugins that are officially recognized by the Xeus development team, you can also display more information about a specific plugin by name.";
    }
