...
public class FeedbackCommand extends Command {
    ...
    public String getDescription() {
        return "Send feedback about Ava back to the developers and the staff team, any message passed to the command will be sent in the [#feedback](https://xeus.pinewood-builders.com/support) channel on the [Xeus Central](https://xeus.pinewood-builders.com/support) server.";
    }
    ...
    private boolean sendFeedback(CommandMessage context, TextChannel feedbackChannel, String message) {
        ...
        placeholderMessage.queue(newMessage -> {
            ...
            try {
                ...
                Xeus.getLogger().error("Failed to store feedback in the database: {}", e.getMessage(), e);
            }
        }, err -> {
            Xeus.getLogger().error("Failed to send feedback message: " + err.getMessage(), err);
