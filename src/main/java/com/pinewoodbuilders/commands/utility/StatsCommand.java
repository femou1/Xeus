...
public class StatsCommand extends Command {
    ...
    public StatsCommand(Xeus avaire) {
        super(avaire);
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        PlaceholderMessage message = context.makeEmbeddedMessage(MessageType.INFO,
            new MessageEmbed.Field(context.i18n("fields.author"), "[Stefano#7366](https://stefanocoding.me/)", true),
        ...
        message
            ...
            .setAuthor("Xeus v" + AppInfo.getAppInfo().version, "https://xeus.pinewood-builders.com/support", avaire.getSelfUser().getEffectiveAvatarUrl())
            .queue();
