...
public class Constants {
    ...
    // Command source link
    public static final String SOURCE_URI = "https://gitlab.com/S-FGR/global-projects/discord-bots/xeus/-/blob/feature/jda-5/src/main/java/com/pinewoodbuilders/commands/%s/%s.java";
