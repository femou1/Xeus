...
public class WatchAction {
     ...
     */
    public WatchAction(@Nonnull WatchType action, @Nonnull User moderator, User target) {
     ...
     * @param target    The target of the modlog action.
     */
    public WatchAction(@Nonnull WatchType action, @Nonnull User moderator, User target, @Nullable String message) {
     ...
     */
    public WatchAction(@Nonnull WatchType action, @Nonnull User moderator, long targetId, @Nullable String message) {
        this.moderator = moderator;
        this.type = action;
        this.message = message;
