...
package com.pinewoodbuilders.admin;
...
public class BotAdmin {
    ...
    public BotAdmin(Xeus avaire, Set<String> botAdmins) {
        this.avaire = avaire;
     ...
     * Xeus Central server, and if the user has the Bot Admin role.
     *
     * @param userId The user ID that should be checked if they're a role admin.
     * @return <code>True</code> if the user has the bot admin role on the Xeus Central
