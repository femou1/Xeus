...
import com.pinewoodbuilders.plugin.translators.PluginHolderTranslator;
import com.pinewoodbuilders.plugin.translators.PluginLoaderTranslator;
...
public class PluginManager {
     ...
     */
    public PluginManager(Xeus avaire) {
        this.avaire = avaire;
     ...
     */
    public void loadPlugins(Xeus avaire) throws InvalidPluginsPathException, InvalidPluginException {
     ...
     */
    public void loadPluginsFromIndex(Xeus avaire) {
    ...
    public boolean unloadPlugin(Plugin plugin) {
        ...
        while (iterator.hasNext()) {
            ...
            next.unregisterPlugin(Xeus.getInstance());
            iterator.remove();
    ...
    public List<PluginHolder> getOfficialPluginsList() {
        Object plugins = Xeus.getInstance().getCache().getAdapter(CacheType.MEMORY).remember("plugins", 10800, () -> {
            try {
