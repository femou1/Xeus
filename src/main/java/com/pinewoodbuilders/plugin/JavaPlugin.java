...
public abstract class JavaPlugin {
     ...
     */
    final void init(Xeus avaire, PluginLoader loader) {
        this.avaire = avaire;
        this.loader = loader;
    ...
    /**
     * Returns the global Xeus application instance.
     *
     * @return The global Xeus application instance.
     */
    public final Xeus getAvaire() {
        return avaire;
    }
