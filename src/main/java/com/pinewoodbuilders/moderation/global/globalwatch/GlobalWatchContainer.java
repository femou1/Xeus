...
public class GlobalWatchContainer {
     ...
     */
    public GlobalWatchContainer(long guildId, long userId, @Nullable Carbon expiresAt, long mainGroupId) {
     ...
     */
    public boolean isSame(@Nonnull GlobalWatchContainer container) {
     ...
     */
    public boolean isSame(long guildId, long userId, long mainGroupId) {
        return getRanGuildId() == guildId
            && getUserId() == userId
    ...
    public boolean equals(Object obj) {
        return obj != null && obj instanceof GlobalWatchContainer && isSame((GlobalWatchContainer) obj);
    }
