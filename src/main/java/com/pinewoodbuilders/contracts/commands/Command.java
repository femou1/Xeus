...
import com.pinewoodbuilders.contracts.reflection.Reflectionable;
import com.pinewoodbuilders.language.I18n;
import com.pinewoodbuilders.middleware.MiddlewareHandler;
import com.pinewoodbuilders.plugin.JavaPlugin;
...
public abstract class Command extends Reflectionable {
    ...
    /**
     * Create the given command instance by calling {@link #Command(Xeus)} with the avaire instance and allowDM set to true.
     *
    ...
    /**
     * Create the given command instance by calling {@link #Command(Xeus, boolean)} with the avaire instance.
     *
     * @param plugin  The plugin instance that is registering the command.
    ...
    /**
     * Creates the given command instance by calling {@link #Command(Xeus, boolean)} with allowDM set to true.
     *
     * @param avaire The Xeus class instance.
     */
    public Command(Xeus avaire) {
        this(avaire, true);
    }
     ...
     * @param allowDM Determines if the command can be used in DMs.
     */
    public Command(Xeus avaire, boolean allowDM) {
        super(avaire);
     ...
     * <p>
     * com.pinewoodbuilders.avaire.commands.utility.PingCommand, the 2nd package from the
