...
import com.pinewoodbuilders.time.Formats;
...
public abstract class ApplicationShutdownCommand extends SystemCommand {
    ...
    /**
     * Creates the given command instance by calling {@link #ApplicationShutdownCommand(Xeus, boolean)} with allowDM set to true.
     *
     * @param avaire The Xeus class instance.
     */
    public ApplicationShutdownCommand(Xeus avaire) {
        this(avaire, true);
    }
     ...
     */
    public ApplicationShutdownCommand(Xeus avaire, boolean allowDM) {
