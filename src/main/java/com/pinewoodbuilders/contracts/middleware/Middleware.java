...
package com.pinewoodbuilders.contracts.middleware;
...
public abstract class Middleware {
     ...
     *
     * @see Metrics#setup(Xeus) Metrics setup.
     */
     ...
     *
     * @param plugin The Xeus application class instance.
     */
