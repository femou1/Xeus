...
package com.pinewoodbuilders.contracts.scheduler;
...
public abstract class Job extends TimerTask implements Reflectional {
    ...
    /**
     * Instantiates the job instance with the given Xeus application instance, with
     * a delay of 0, period of 1, and time unit of {@link TimeUnit#MINUTES}.
     *
     * @param avaire The Xeus application instance.
     */
    public Job(Xeus avaire) {
        this(avaire, 0);
    }

    /**
     * Instantiates the job instance with the given Xeus application instance and delay,
     ...
     */
    public Job(Xeus avaire, long delay) {
        this(avaire, delay, 1);
    }

    /**
     * Instantiates the job instance with the given Xeus application instance, delay,
     ...
     */
    public Job(Xeus avaire, long delay, long period) {
        this(avaire, delay, period, TimeUnit.MINUTES);
    }

    /**
     * Instantiates the job instance with the given Xeus application
     ...
     */
    public Job(Xeus avaire, long delay, long period, TimeUnit unit) {
        this.avaire = avaire;
