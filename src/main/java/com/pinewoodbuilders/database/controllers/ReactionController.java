...
public class ReactionController {
     ...
     */
    @CheckReturnValue
    public static Collection fetchReactions(Xeus avaire, Message message) {
     ...
     */
    @CheckReturnValue
    public static Collection fetchReactions(@Nonnull Xeus avaire, @Nullable Guild guild) {
        if (guild == null) {
            return null;
        }
     ...
     */
    @CheckReturnValue
    public static ReactionTransformer fetchReactionFromMessage(Xeus avaire, Message message) {
