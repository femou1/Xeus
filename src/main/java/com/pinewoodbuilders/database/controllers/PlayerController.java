...
import com.pinewoodbuilders.level.ExperienceEntity;
...
public class PlayerController {
    ...
    @CheckReturnValue
    public static PlayerTransformer fetchPlayer(Xeus avaire, Message message) {
        return fetchPlayer(avaire, message, message.getAuthor());
    }


    @CheckReturnValue
    public static PlayerTransformer fetchPlayer(Xeus avaire, Message message, User user) {
    ...
    private static PlayerTransformer mergeWithExperienceEntity(Xeus avaire, PlayerTransformer transformer) {
