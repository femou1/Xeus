...
public class PlaylistController {
    ...
    @CheckReturnValue
    public static Collection fetchPlaylists(Xeus avaire, Message message) {
    ...
    @CheckReturnValue
    public static PlaylistTransformer fetchPlaylistFromName(Xeus avaire, Message message, String name) {
