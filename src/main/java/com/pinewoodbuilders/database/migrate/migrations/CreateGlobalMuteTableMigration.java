...
public class CreateGlobalMuteTableMigration implements Migration {

    @Override
    public String created_at() {
        return "Sat, Jan 15, 2022 12:18 PM";
    }

    @Override
    public boolean up(Schema schema) throws SQLException {
        return schema.createIfNotExists(Constants.GLOBAL_MUTE_TABLE_NAME, table -> {
