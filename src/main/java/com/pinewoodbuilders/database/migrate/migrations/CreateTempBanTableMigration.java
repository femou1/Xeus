...
public class CreateTempBanTableMigration implements Migration {

    @Override
    public String created_at() {
        return "Sat, Oct 2, 2021 11:54 AM";
    }

    @Override
    public boolean up(Schema schema) throws SQLException {
        return schema.createIfNotExists(Constants.BAN_TABLE_NAME, table -> {
    ...
    public boolean down(Schema schema) throws SQLException {
        return schema.dropIfExists(Constants.BAN_TABLE_NAME);
    }
}
