...
public class AddMainGroupIdToOnWatchTableMigration implements Migration {

    @Override
    public String created_at() {
        return "Fri, Oct 08, 2021 9:53 AM";
    }

    @Override
    public boolean up(Schema schema) throws SQLException {
        if (schema.hasColumn(Constants.ON_WATCH_TABLE_NAME, "main_group_id")) {
            return true;
        }

        schema.getDbm().queryUpdate(String.format(
            "ALTER TABLE `%s` ADD `main_group_id` BOOLEAN NOT NULL DEFAULT '0';",
