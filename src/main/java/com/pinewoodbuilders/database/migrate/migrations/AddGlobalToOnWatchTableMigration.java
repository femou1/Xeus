...
public class AddGlobalToOnWatchTableMigration implements Migration {

    @Override
    public String created_at() {
        return "Thu, Oct 06, 2021 7:45 PM";
    }

    @Override
    public boolean up(Schema schema) throws SQLException {
        if (schema.hasColumn(Constants.ON_WATCH_TABLE_NAME, "global")) {
            return true;
        }
