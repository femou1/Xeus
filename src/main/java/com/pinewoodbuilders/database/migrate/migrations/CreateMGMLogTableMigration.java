...
public class CreateMGMLogTableMigration implements Migration {
    ...
    public boolean up(Schema schema) throws SQLException {
        return schema.createIfNotExists(Constants.MGM_LOG_TABLE_NAME, table -> {
            table.Integer("type", 2);
            table.Integer("modlogCase");
            table.Long("mgi").unsigned();
    ...
    public boolean down(Schema schema) throws SQLException {
        return schema.dropIfExists(Constants.MGM_LOG_TABLE_NAME);
    }
}
