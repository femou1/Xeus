...
public class AddMainGroupIdToMuteTableMigration implements Migration {

    @Override
    public String created_at() {
        return "Fri, Oct 08, 2021 9:54 AM";
    }

    @Override
    public boolean up(Schema schema) throws SQLException {
        if (schema.hasColumn(Constants.MUTE_TABLE_NAME, "main_group_id")) {
            return true;
        }
