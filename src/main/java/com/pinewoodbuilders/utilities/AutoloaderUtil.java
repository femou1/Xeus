...
public class AutoloaderUtil {
     ...
     * will be instantiated with the Xeus instance passed to the
     ...
     * <p>
     * If the {@code parseAvaIreInstance} argument is set to true, the Xeus
     ...
     * @param path                The package path that should be autoloaded.
     * @param callback            The consumer used to register the loaded class.
     * @param parseAvaIreInstance Determines if the Xeus instance should be passed
